...
<html lang="en" class="no-js">
	<head>
		<meta charset="utf-8">
		<title>eMoviesz.pk | Admin | music</title>
      ...
      <button class="btn btn-primary btn-just-icon"><i class="pe-7s-search"></i></button>
       ...
       <div class="Datauploadcontainer"> <!--  Start Data upload container -->
              <div  id="adminform"> <!-- start adminform div -->
                ...
                <center><b class="registation admislmfontup">Upload New Music</b></center> <br>
                  <form id="insertform">
                  <div class="row"> <!-- start of 1 row -->
                     <div class=" col-md-2 col-xs-6 form-group borderround admbtnlf">
                    <label>MovieName</label>
                     <input type="text" name="Movie_Name" class="form-control btnwth" placeholder="Enter ItemName"id="Movie_Name"required>
                     </div>
                    ...
                    <div class=" col-md-2 col-xs-6 form-group borderround admbtnrgt">
                      <label class="admislmfont">DownRate</label>
                       <input type="text" name="Down_Rate" class="form-control btnwth" placeholder="Enter DownloadLink"id="Down_Rate"required>
                      </div>

                      <div class=" col-md-2 col-xs-6 form-group borderround  admbtnlf">
                    <label>TotalTrack</label>
                     <input type="text" name="Total_Track" class="form-control btnwth" placeholder="EnterTotalTrac"id="Total_Track"required>
                    </div>

                    <div class=" col-md-2 col-xs-6 form-group borderround admbtnrgt">
                    <label>Songname</label>
                     <input type="text" name="Song_name" class="form-control btnwth" placeholder="Songname"id="Song_name"required>
                    </div>
                    ...
                    <div class=" col-md-2 col-xs-6 form-group inputstyle  admbtnlf">
                      ...
                      <select name="Categories" class="form-control btnwth"id="Categories"required>
                        ...
                        <option>Bhangra/punjabi</option>
                        <option>Bollywood Movies Songs</option>
                        <option>Ghazals</option>
                        <option>Indian Pop Remix</option>
                        <option>Pakistani Songs</option> 
                      </select>
                    </div>
                      <!-- <div class=" col-md-2 col-xs-6 form-group borderround admbtnrgt">
        ...
        <label for="file-1"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg><span class="admislmfont"></span></label> 
                   ...
                   <div class=" col-md-2  col-xs-6 form-group borderround">
                       <label class="admislmfont ">Musicfolder </label>
                       <input type="file" name="movupbt" id="file-3" class="inputfile inputfile-1"id="musicfolder"required accept=".mp3">
                    ...
                    <div class="centrdivmov">
                      <div class="  lg-col-6 col-md-6 col-sm-12 col-xs-12 form-group borderround">
              ...
              <div class="modal fade " id="UpdateModal">
                ...
                <div class="modal-header">
                    <h4 class="modal-title modal-title-text text-center">Music all content update</h4>
                ...
                <form  method="post" id="Updateform">
                        <div class='modal-body'>
                          ...
                          <div class=" col-md-2 col-xs-6 form-group borderround admbtnlf">
                    <label>MovieName</label>
                     <input type="text" name="Movie_Name" class="form-control btnwth Movie_Name">
                     </div>
                    ...
                    <div class=" col-md-2 col-xs-6 form-group borderround admbtnrgt">
                      <label class="admislmfont">DownRate</label>
                       <input type="text" name="Down_Rate" class="form-control btnwth Down_Rate">
                      </div>

                      <div class=" col-md-2 col-xs-6 form-group borderround  admbtnlf">
                    <label>TotalTrack</label>
                     <input type="text" name="Total_Track" class="form-control btnwth Total_Track">
                    </div>

                    <div class=" col-md-2 col-xs-6 form-group borderround admbtnrgt">
                    <label>Songname</label>
                     <input type="text" name="Song_name" class="form-control btnwth Song_name">
                    </div>
        ...
        function loadTable(){
           $.ajax({
            url:"music_ajax_request_pages.php",
            type:"POST",
               ...
               //  end insert data with ajax
                    ...
                    $(document).on('click','.edit-btn',function(){
                      // var islamic_id = $(this).closest("tr").find('.stud_id').text();
                        ...
                        var music_id = $(this).data('editid');
                        $('#music_id').val(music_id);
                        $.ajax({
                           url:"music_ajax_request_pages.php",
                           method:"POST",
                           data:{music_id:music_id, action:'edit'},
                           dataType:"json", 
                           success:function(data){
                            ...
                            $('.Add_Date').val(data.Add_Date);
                               ...
                               $('.Total_Track').val(data.Total_Track);
                               $('.Down_Rate').val(data.Down_Rate);

                               $('.VD_rate').val(data.V_Drate);
                               ...
                               $('.poster_preview').html('<img src="Alluploadfolder/musicposter/'+data.Poster+'" height="70" width="70"/>');
                               $('.audio_music').html('<audio controls style="width: 210px;"><source src="Alluploadfolder/Musicfolder/'+data.filename+'"type="audio/mp3"></audio>');
