...
<html lang="en" class="no-js">
	<head>
		<meta charset="utf-8">
		<title>eMoviesz.pk | Admin | webtv</title>
 ...
 .check_error_message .fa-bomb{
    ...
    <form action="search" method="get" class="navbar-form navbar-right navbar-search-form" role="search" >
      ...
      <button class="btn btn-primary btn-just-icon"><i class="pe-7s-search"></i></button>
          ...
          <div class="col-md-3">
           ...
           <div class="Datauploadcontainer"> <!--  Start Data upload container -->
              <div  id="adminform"> <!-- start adminform div -->
                ...
                <center><b class="registation admislmfontup">Upload New WebTv</b></center> <br>
                  <form id="insertform">
                  <div class="row"> <!-- start of 1 row -->
                  
                     <div class=" col-md-2 col-xs-6 form-group borderround admbtnlf">
                    <label>ItemName</label>
                     <input type="text" name="channel_name" class="form-control btnwth" placeholder="Enter Channel"id="channel_name"required>
                     </div>
                    ...
                    <div class=" col-md-2  col-xs-6 form-group borderround admbtnlf">
                       <label class="admislmfont ">Channel_link </label>
                       <input type="text" name="chanel_link" class="form-control btnwth"placeholder="chanel_link"id="chanel_link"required>
        ...
        <label for="file-1"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg><span class="admislmfont"></span></label>
                ...
                <form  method="post" id="Updateform">
                        <div class='modal-body'>
                          ...
                          <input type='hidden'name='webtv_id'id='webtv_id'>


                          <div class=" col-md-2 col-xs-6 form-group borderround admbtnlf">
                    <label>ItemName</label>
                     <input type="text" name="channel_name" class="form-control btnwth channel_name">
                     </div>
                    ...
                    <div class=" col-md-2 col-xs-6 form-group borderround admbtnrgt">
                    <label>Keywords</label>
                     <input type="text" name="search_keyword1" class="form-control btnwth search_keyword">
                    </div>
                    ...
                    <div class=" col-md-2  col-xs-6 form-group borderround admbtnlf">
                       <label class="admislmfont ">Channel_link </label>
                       <input type="text" name="chanel_link" class="form-control btnwth chanel_link">
                    </div> 
        ...
        function loadTable(){
           $.ajax({
            url:"webtv_ajax_request_pages.php",
            type:"POST",
           ...
           e.preventDefault();
               ...
               //  end insert data with ajax
                    ...
                    $(document).on('click','.edit-btn',function(){
                        ...
                        var webtv_id = $(this).data('editid');
                        $('#webtv_id').val(webtv_id);
                        $.ajax({
                           url:"webtv_ajax_request_pages.php",
                           method:"POST",
                           data:{webtv_id:webtv_id, action:'edit'},
                           dataType:"json", 
                           success:function(data){
                               ...
                               $('.chanel_link').val(data.Channel_link);
                               $('.Poster_old_image').val(data.Poster);
                               
                               $('.poster_preview').html('<img src="Alluploadfolder/webposter/'+data.Poster+'" height="70" width="70"/>');
