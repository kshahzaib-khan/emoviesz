...
<html lang="en" class="no-js">
	<head>
		<meta charset="utf-8">
		<title>eMoviesz.pk | Admin | software</title>
...
.check_success_message{
 ...
 .check_error_message .fa-bomb{
            ...
            <div class="panel-footer">
             <a href=""> View<i class="fa fa-arrow-circle-right pull-right"></i></a>
              ...
              <div id="adminform"> <!-- start adminform div -->
                ...
                <center><b class="registation admislmfontup">Upload New Software</b></center> <br>
                  <form id="insertform">
                  <div class="row"> <!-- start of 1 row -->
                    ...
                    <label>ViewsRate</label>
                     <input type="text" name="Views" class="form-control btnwth" placeholder=" Enter Views"id="Views"requires>
                    </div>
                    ...
                    <div class=" col-md-2 col-xs-6 form-group inputstyle admbtnlf">
                      ...
                      <select name="Categories1" class="form-control btnwth"id="Categories1"required>
                      <option value=""hidden >Select</option>
                        ...
                        <option value="InternetTools">Internet Tools</option> 
                        <option value="NetworkTools">Network Tools</option>
                        <option value="DeveloperTools">Developer Tools</option>
                        <option value="OperatingSystem"> Operating System</option>
                        <option value="Telephony">Telephony</option>
                        <option value="DvD Burning" value="">DvD Burning</option> 
                      </select>
                    </div>
                    ...
                    <div class=" col-md-2 col-xs-6 form-group inputstyle admbtnrgt ">
                      ...
                      <option value=""hidden >Select</option>
                        ...
                        <option value="MacOS">MacOS</option> 
                         <option value="Office">Office</option> 
                        <option value="Desktop">Desktop</option>
                        <option value="AndroidApps">Android Apps</option>
                        <option value="Anti-Malware">Anti-Malware</option>
                        <option value="Converter">Converter</option>
                        <option value="Graphics">Graphics</option> 
                        <option value="Browsers">Browsers</option>
                        ...
                        <option value="DeveloperTools">Developer Tools</option>
                        <option value="Telephony">Telephony</option>
                        <option value="DvDBurning">DvD Burning</option>
                      </select>
                    </div>
                    ...
                    <label>Keywords</label>
                     <input type="text" name="Keywords" class="form-control btnwth"placeholder="Enter Keywords"id="Keywords"required>
                      ...
                      <div class=" col-md-2 col-xs-6 form-group borderround admbtnrgt">
                    <label>DBWNISO</label>
                     <input type="text" name="DBWNISO" class="form-control btnwth" placeholder="Enter download_link"id="DBWNISO"required>
                    </div>
    ...
    <!-- Modal content-->
                 ...
                 <h4 class="modal-title modal-title-text text-center">Software all content update</h4>
                             </div>
                    ...
                    <div class=" col-md-2 col-xs-6 form-group borderround admbtnrgt">
                    <label>DBWNISO</label>
                     <input type="text" name="DBWNISO" class="form-control btnwth DBWNISO">
                    </div>
                    <div class=" col-md-2 col-xs-6 form-group borderround admbtnlf">
                       <label class="admislmfont">Description</label>
       ...
       <!-- start UpdateModal form -->
        ...
        function loadTable(){
           $.ajax({
            url:"software_ajax_request_pages.php",
            type:"POST",
               ...
               //  end insert data with ajax
                    ...
                    $(document).on('click','.edit-btn',function(){
                      // var islamic_id = $(this).closest("tr").find('.stud_id').text();
                        ...
                        var software_id = $(this).data('editid');
                        $('#software_id').val(software_id);
                        $.ajax({
                           url:"software_ajax_request_pages.php",
                           method:"POST",
                           data:{software_id:software_id, action:'edit'},
                           dataType:"json", 
                           success:function(data){
                               ...
                               $('.poster_preview').html('<img src="Alluploadfolder/softposter/'+data.poster+'" height="55" width="55"/>');
