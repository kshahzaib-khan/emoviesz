...
<html lang="en" class="no-js">
	<head>
		<meta charset="utf-8">
		<title>eMoviesz.pk | Admin | wallpapers</title>
 ...
 .check_error_message .fa-bomb{
    ...
    <form action="search" method="get" class="navbar-form navbar-right navbar-search-form" role="search" >
      ...
      <button class="btn btn-primary btn-just-icon"><i class="pe-7s-search"></i></button>
       ...
       <div class="Datauploadcontainer"> <!--  Start Data upload container -->
              <div  id="adminform"> <!-- start adminform div -->
                ...
                <center><b class="registation admislmfontup">Upload New Wallpapers</b></center> <br>
                  <form id="insertform">
                  <div class="row"> <!-- start of 1 row -->
                     <div class=" col-md-2 col-xs-6 form-group borderround admbtnlf">
                    <label> FullName</label>
                     <input type="text" name="Full_Name" class="form-control btnwth" placeholder="Enter Full_Name"id="Full_Name"required>
                     </div>
                    ...
                    <label>DownloadRate</label>
                     <input type="text" name="Download_Rate" class="form-control btnwth" placeholder="Enterkeywords"id="Download_Rate"required>
                    </div>

                    <div class=" col-md-2 col-xs-6 form-group borderround admbtnlf">
                      <label>PicRelateN</label>
                       <input type="text" name="PicRelateN" class="form-control btnwth"placeholder="Enter PicRelateN"id="PicRelateN"required>
                      </div>
        ...
        <label for="file-1"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg><span class="admislmfont"></span></label>
                    ...
                    <div class="centrdivsoft">
                      <div class=" col-md-2 col-sm-12 col-xs-12  borderround subbtnislm">
                ...
                <form  method="post" id="Updateform">
                        <div class='modal-body'>
                          ...
                          <input type='hidden'name='wallpaper_id'id='wallpaper_id'>


                          <div class=" col-md-2 col-xs-6 form-group borderround admbtnlf">
                    <label> FullName</label>
                     <input type="text" name="Full_Name" class="form-control btnwth Full_Name">
                     </div>
                    ...
                    <div class=" col-md-2 col-xs-6 form-group borderround admbtnrgt">
                    <label>Keywords</label>
                     <input type="text" name="search_keyword" class="form-control btnwth search_keyword">
                    </div>

                    <div class=" col-md-2 col-xs-6 form-group borderround admbtnlf">
                      <label>PicRelateN</label>
                       <input type="text" name="PicRelateN" class="form-control btnwth PicRelateN">
                      </div>
     ...
     <script>
        ...
        function loadTable(){
           $.ajax({
            url:"wallpaper_ajax_request_pages.php",
            type:"POST",
           ...
           e.preventDefault();
               ...
               //  end insert data with ajax
                    ...
                    $(document).on('click','.edit-btn',function(){
                        ...
                        var wallpaper_id = $(this).data('editid');
                        $('#wallpaper_id').val(wallpaper_id);
                        $.ajax({
                           url:"wallpaper_ajax_request_pages.php",
                           method:"POST",
                           data:{wallpaper_id:wallpaper_id, action:'edit'},
                           dataType:"json", 
                           success:function(data){
                            ...
                            $('.Add_Date').val(data.Add_Date);
                               ...
                               $('.search_keyword').val(data.Keywords);
                               $('.select_categories').val(data.Categories);
                               $('.PicRelateN').val(data.PicRelateN);

                               $('.Poster_old_image').val(data.filename);
                               
                               $('.poster_preview').html('<img src="Alluploadfolder/walpaperposter/'+data.filename+'" height="70" width="70"/>');
