...
<html lang="en" class="no-js">
	<head>
		<meta charset="utf-8">
		<title>eMoviesz.pk | Admin | onlinegames</title>
      ...
      <button class="btn btn-primary btn-just-icon"><i class="pe-7s-search"></i></button>
       ...
       <div class="Datauploadcontainer"> <!--  Start Data upload container -->
              <div  id="adminform"> <!-- start adminform div -->
                ...
                <center><b class="registation admislmfontup">Upload New OnlineGames</b></center> <br>
                  <form id="insertform">
                  <div class="row"> <!-- start of 1 row -->

                     <div class=" col-md-2 col-xs-6 form-group borderround admbtnlf">
                    <label>GameName</label>
                     <input type="text" name="Game_Name" class="form-control btnwth" placeholder="Enter Game_Name"id="Game_Name"required>
                     </div>
                    ...
                    <label>keywords</label>
                     <input type="text" name="keywords" class="form-control btnwth" placeholder="Enterkeywords"id="keywords"required>
                    </div>

                    <div class=" col-md-2 col-xs-6 form-group inputstyle admbtnlf">
                      <label>Categories</label>
                      <select name="Categories" class="form-control btnwth">
                        <option value="">Select</option>
                        <option value="Action">Action</option>
                        <option value="Adventure">Adventure</option>
                        <option value="Air Craf">Air Craf</option>
                    ...
                    <div class=" col-md-2  col-xs-6 form-group borderround filebtnislm admbtnrgt">
                      <label class="admislmfont ">Game_link </label>
                      <input type="text" name="game_link" class="form-control btnwth" placeholder="Game_link"required>
                  ...
                  <!--   <div class=" col-md-2 col-xs-6 form-group borderround admbtnlf">
                    <label>Keywords</label>
                     <input type="text" name="Keywords" class="form-control btnwth"placeholder="Enter Keywords">
                    </div>

                      <div class=" col-md-2 col-xs-6 form-group borderround admbtnrgt">
                    <label>downloadlink</label>
                     <input type="text" name="downloadlink" class="form-control btnwth" placeholder="Enter downloadlink">
                    </div>

                    
                    <div class=" col-md-2 col-xs-6 form-group borderround admbtnlf">
                       <label class="admislmfont">Description</label>
                       <textarea style="height: 35px;" name="Description" class="form-control btnwth " row="6" placeholder=" Description"></textarea>
                     </div>
             -->
                   ...
                   <div class=" col-md-2  col-xs-6 form-group borderround admbtnlf">
                    ...
                    <div class="">
                    <div class=" col-md-2  col-xs-6 form-group borderround subbtnislm admbtnrgt">
                       <label> Submit</label>
                ...
                <form  method="post" id="Updateform">
                        <div class='modal-body'>
                          ...
                          <input type='hidden'name='onlinegame_id'id='onlinegame_id'>


                          <div class=" col-md-2 col-xs-6 form-group borderround admbtnlf">
                    <label>MovieName</label>
                     <input type="text" name="Game_Name" class="form-control btnwth Game_Name">
                     </div>
                    ...
                    <div class=" col-md-2 col-xs-6 form-group borderround admbtnrgt">
                      ...
                      <select name="fetch_Categories" class="form-control btnwth select_categories">
                        <option value="">Select</option>
                        <option value="Action">Action</option>
                        <option value="Adventure">Adventure</option>
                        <option value="Air Craf">Air Craf</option>
                    ...
                    <div class=" col-md-2 col-xs-6 form-group borderround admbtnrgt">
                      <label class="admislmfont">Game_link</label>
                       <input type="text" name="game_link" class="form-control btnwth game_link">
                      </div>
        ...
        function loadTable(){
           $.ajax({
            url:"onlinegame_ajax_request_pages.php",
            type:"POST",
           ...
           e.preventDefault();
               ...
               //  end insert data with ajax
                    ...
                    $(document).on('click','.edit-btn',function(){
                        ...
                        var onlinegame_id = $(this).data('editid');
                        $('#onlinegame_id').val(onlinegame_id);
                        $.ajax({
                           url:"onlinegame_ajax_request_pages.php",
                           method:"POST",
                           data:{onlinegame_id:onlinegame_id, action:'edit'},
                           dataType:"json", 
                           success:function(data){
                            ...
                            $('.Add_Date').val(data.Add_Date);
                               ...
                               $('.game_link').val(data.game_link);

                               $('.old_filename').val(data.filename);
                               $('.Poster_old_image').val(data.Poster);
                               
                               $('.poster_preview').html('<img src="Alluploadfolder/ongameposter/'+data.Poster+'" height="70" width="70"/>');
