  ...
  <!-- Start Mobile Search Engine -->
    ...
    <div class="main2 visible-sm visible-xs mbht containerSearchMobileEngine">
      ...
      <div class="form-group" style="display:inline;">
        ...
        <div class="input-group"> 
          <div class="input-group center-block">
              <input action="" class="form-control" id="search-input2" name="search_query" class="search-input" type="text" placeholder="search music album" style="padding: 5px;border-radius: 4px 0px 0px 4px;">
          </div>
...
$result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `music`");
...
{  
     ...
     $query = "SELECT * FROM music WHERE Movie_Name LIKE '$character%'";  
}  
else  
{  
     $query = "SELECT * FROM music ORDER BY id DESC  limit $offset, $total_records_per_page";  
}  
...
?>
    ...
    <div class= "container" style="background-color:white"><!-- main container start -->
      ...
      <div class="row"> <!--  all center data main row start -->
        ...
        <div class="panel-heading MLfonts"><span class="toll" data-toggle="tooltip" title="Music">Music </span> Album › Random</div>
 ...
 <li class="btn btn-default pgbt66"><a href="music.php?q=num" class="">0-9</a></li>
  ...
  <?php  
      ...
      foreach($character as $alphabet)  
        {  
     echo '<li class="btn btn-default pgbt6"><a href="music.php?character='.$alphabet.'">'.$alphabet.'</a></li>';  
          }  
                         // echo '</ul>';  
      ?>
  </div> 
 ...
 <span class="input-group-btn btn-block floatrightinput">
    ...
    <option value="Title">By Title</option>
        ...
        <div class="panel-body adbttpmg" style="background-color:white;">
         ...
         <div class="row" ><!-- Start of music row > -->
         ...
         <?php
          ...
          if(isset($_GET['search_query']) OR isset($_GET['Allcate'])){
            ...
            $query = "SELECT * FROM music WHERE Keywords = '$search_query' OR Categories = '$Allcate' ";
             ...
             <a href="musicpreview.php?id=<?php echo $id; ?>">
            <div class="col-item">
              <div class="photo col-sm-12 col-xs-5">
              <?php echo "<img src='Admin/Alluploadfolder/Musicposter/$poster' class='img-responsive poster posternonround' alt=''>"?>

                <!-- <img src="music/mu1.jpg" class="img-responsive poster posternonround" alt="Jagga Jasoos"> -->
                </div>
              <div class="info col-sm-12 col-xs-7 textopmrgmusicpg">
                <h6 class="category text-music" title='<?php echo $name;?>'><?php echo $name;?> </h6>
                <div class="row">   
                 <div class="col-xs-9">
