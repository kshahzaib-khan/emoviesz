...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>eMoviesz.pk| islamic</title>
      ...
      <div class="form-group" style="display:inline;">
        <div class="input-group">
          ...
          <option value="Bayaan">Bayaan</option>
           <option value="Shareef">Naat Shareef</option>
          </select> 
          </span>   
  ...
  <!-- Start Mobile Search Engine -->
    ...
    <div class="main2 visible-sm visible-xs mbht containerSearchMobileEngine">
      ...
      <div class="form-group" style="display:inline;">
        ...
        <div class="input-group"> 
          <div class="input-group center-block">
              <input action="movies" class="form-control" id="search-input2" name="search_query" class="search-input" type="text" placeholder="search Islamic Album" style="padding: 5px;border-radius: 4px 0px 0px 4px;">
          </div>
...
$result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `islamic`");
...
{  
     ...
     $query = "SELECT * FROM islamic WHERE Keywords LIKE '$character%'";  
}  
else  
{  
     $query = "SELECT * FROM islamic ORDER BY id DESC  limit $offset, $total_records_per_page";  
}  
...
?> 
    ...
    <div class= "container" style="background-color:white"><!-- main container start -->
      ...
      <div class="row"> <!--  all center data main row start -->
        ...
        <div class="panel-heading MLfonts"><span class="toll" data-toggle="tooltip" title="Islamic">Islamic </span> Album › Random</div>
 ...
 <li class="btn btn-default pgbt66"><a href="islamic.php?q=num" class="">0-9</a></li>
  ...
  <?php  
                         ...
                         // echo '<ul class="pagination ">';  
                          ...
                          {  
                               echo '<li class="btn btn-default pgbt6"><a href="islamic.php?character='.$alphabet.'">'.$alphabet.'</a></li>';  
                          }  
                         // echo '</ul>';  
                     ?> 
 </div>     
        ...
        <div class="panel-body adbttpmg" style="background-color:white;">
         ...
         <?php
          ...
          if(isset($_GET['search_query']) OR isset($_GET['Allcate'])){
            ...
            $query = "SELECT * FROM islamic WHERE Keywords = '$search_query' OR Categories = '$Allcate' ";
            ...
            <a href="islamicpreview.php?id=<?php echo $id; ?>">
            <div class="col-item">
              <div class="photo col-sm-12 col-xs-5">
              <?php echo "<img src='Admin/Alluploadfolder/islamicposter/$poster' class='img-responsive poster posternonround' alt=''>"?>

                <!-- <img src="islamic/is1.jpg" class="img-responsive poster posternonround" alt="Hafiz Tahir Qadri"> -->
                </div>
              <div class="info col-sm-12 col-xs-7 textopmrgislamicpg" >
              <h6 class="category text-rose" title='<?php echo $name;?>' ><?php echo $name;?></h6>

                <!-- <h6 class="category text-rose" title="Hafiz Tahir Qadri"> Hafiz Tahir Qadri</h6> -->
                <div class="row">   
                 <div class="col-xs-9">
                  <div class="infohd">Total Track :<?php echo $Total_Tracks;?></div>
                  <div class="infohd">V/D :<?php echo $VD_rate;?> </div>
