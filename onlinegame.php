...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>eMoviesz.pk | Onlinegame</title>
...
<br><br><br><br><br><br>
    ...
    <br>
     ...
     <div class="container">
      ...
      <input class="form-control" id="search-input2" name="search_query" type="text" placeholder="search Online games" autocomplete="off">
  ...
  <!-- Start Mobile Search Engine -->
    ...
    <div class="main2 visible-sm visible-xs mbht containerSearchMobileEngine">
      ...
      <div class="form-group" style="display:inline;">
        ...
        <div class="input-group"> 
          <div class="input-group center-block">
              <input type="text" class="form-control" name="search_query" class="search-input" type="text" placeholder="search Online games" style="padding: 5px;border-radius: 4px 0px 0px 4px;">
          </div>
...
$result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `onlinegame`");
...
{  
     ...
     $query = "SELECT * FROM onlinegame WHERE GameName LIKE '$character%'";  
}  
else  
{  
     $query = "SELECT * FROM onlinegame ORDER BY id DESC  limit $offset, $total_records_per_page";  
}  
...
?>
    ...
    <div class= "container" style="background-color:white"><!-- main container start -->
      ...
      <div class="row"> <!--  all center data main row start -->
        ...
        <div class="panel panel-default LatestMovies mbsmgtp">
         <div class="panel-heading MLfonts"> <span class="toll" data-toggle="tooltip" title="Online Games">Online Games</span> › All Random</div>
 ...
 <li class="btn btn-default pgbt66"><a href="onlinegamebtn.php?q=num" class="">0-9</a></li>
  ...
  <?php  
      ...
      foreach($character as $alphabet)  
        {  
     echo '<li class="btn btn-default pgbt6"><a href="onlinegame.php?character='.$alphabet.'">'.$alphabet.'</a></li>';  
          }  
                         // echo '</ul>';  
      ?>
  </div>
 ...
 <span class="input-group-btn btn-block floatrightinput">
    ...
    <option value="Title">By Title</option>
        ...
        <div class="panel-body adbttpmg" style="background-color:white;">
          ...
          <div class="row"><!-- Onlinegames 1 row start -->
          <?php
          ...
          if(isset($_GET['search_query']) OR isset($_GET['Allcate'])){
            ...
            $query = "SELECT * FROM onlinegame WHERE Keywords = '$search_query' OR Categories = '$Allcate' ";
            ...
            <div class="col-item">
              ...
              <div class="info col-sm-12 col-xs-7 textopmrgolinegamepg ">
                <h6 class="category text-ongm " title='<?php echo $name;?>'><?php echo $name;?> </h6>
                <div class="row">   
