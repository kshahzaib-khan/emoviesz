...
<br><br><br><br><br><br>
  ...
  <!-- Start Mobile Search Engine -->
    ...
    <div class="main2 visible-sm visible-xs mbht containerSearchMobileEngine">
      <div class="container">
      <form action="movies" method="get" class="navbar-form2" accept-charset="utf-8">
      <div class="form-group" style="display:inline;">
        <div class="input-group">
        ...
        <div class="input-group"> 
          <div class="input-group center-block">
              <input action="movies" class="form-control" id="search-input2" name="search_query" class="search-input" type="text" placeholder="search Software" style="padding: 5px;border-radius: 4px 0px 0px 4px;">
          </div>
    ...
    <option value="Title">By Title</option>
        ...
        <!-- <div class="panel-body adbttpmg" style="background-color:white;padding-top: 28px;"> -->
          ...
          if(isset($_GET['search_query']) OR isset($_GET['Allcate'])){
            ...
            $query = "SELECT * FROM software WHERE Keywords = '$search_query' OR Categories1 = '$Allcate' ";
