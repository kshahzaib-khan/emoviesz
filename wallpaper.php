...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>eMoviesz.pk | wallpaper</title>
...
$result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `wallpaper`");
...
?>
    ...
    <div class= "container" style="background-color:white;"><!-- main container start -->
      ...
      <div class="row"> <!--  all center data main row start -->
        ...
        <div class="panel-heading MLfonts"><span class="toll"data-toggle="tooltip" title="Wallpaper">Wallpaper</span>  › All Random</div>


        <div class="panel-body " style="background-color:white; padding-top: 3px;">
          
              

         <div class="row" ><!--  wallpaper 1 row start > -->
          ...
          if(isset($_GET['search_query']) OR isset($_GET['Allcate'])){
            ...
            $query = "SELECT * FROM wallpaper WHERE Keywords = '$search_query' OR Categories = '$Allcate' ";
             ...
             if(mysqli_num_rows($result) > 0){
               ...
               <a href="wallpaperpreview.php?id=<?php echo $id;?>">
                  ...
                  <?php echo "<img src='Admin/Alluploadfolder/walpaperposter/$Poster' class='img-responsive  posternonround' alt=''>"?>
                   ...
                   <div class="info">
                    <h6 class="category text-vidio" title='<?php echo $FullName ?>'><?php echo $FullName ?></h6>
          ...
          if(!isset($_GET['search_query'] ) AND !isset($_GET['Allcate'])){
            ...
            $query = "SELECT * FROM wallpaper ORDER BY id DESC  limit $offset, $total_records_per_page";
